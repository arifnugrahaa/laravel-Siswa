...
<h1 class="h3 mb-2 text-gray-800">Perubahan Data Kelas</h1>
<p class="mb-4">Silahkan gunakan form dibawah ini untuk merubah data kelas.</p>
        ...
        <form method="POST" action="/kelas">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_kelas" maxlength="10" onKeyUp="this.value=this.value.toUpperCase()"
                    ...
                    autocomplete="off" value="{{ old('nama_kelas', $data->nama_kelas) }}" autofocus required />
                @error('nama_kelas')
            ...
            <div class="form-group">
                ...
                <input type="text" maxlength="50" onkeypress="return event.charCode < 48 || event.charCode >57"
                    onKeyUp="this.value=this.value.toUpperCase()" value="{{ old('jurusan', $data->jurusan) }}"  name="jurusan"
